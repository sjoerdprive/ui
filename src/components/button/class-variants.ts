  ...
  ],
  {
    variants: {
      ...
      variant: {
        ...
        border:
          "not-disabled:hover:bg-(--theme-100) border border-(--theme-500) disabled:border-input-disabled-text has-disabled:border-input-disabled-text text-(--theme-700) active:bg-(--theme-200) has-checked:bg-(--theme-200)",
      },
      square: {
