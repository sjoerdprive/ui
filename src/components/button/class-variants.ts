...
export const buttonClassVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      variant: {
        solid:
          "not-disabled:hover:bg-(--theme-600,var(--color-gray-100)) bg-(--theme-500) active:bg-(--theme-600) has-checked:bg-(--theme-600) has-checked:inset-shadow-sm inset-shadow-(color:--theme-700) has-disabled:inset-shadow-(color:--color-input-disabled-text) text-white",
        border:
