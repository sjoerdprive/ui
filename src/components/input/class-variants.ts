...
export const inputClassVariants = cva(
  [
    "px-3 bg-white disabled:cursor-not-allowed disabled:text-input-disabled-text disabled:bg-input-disabled-bg has-disabled:cursor-not-allowed has-disabled:text-input-disabled-text has-disabled:bg-input-disabled-bg flex flex-nowrap items-center justify-start",
    inputBorderClass,
  ],
  {
    variants: {
